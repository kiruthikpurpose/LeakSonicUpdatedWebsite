...
export default function HomePage() {
  return (
    <>
      ...
      {/* 3c - What the operator works from (dashboard mock) */}
      <section className="border-b border-line bg-base py-section">
        <div className="container-content grid grid-cols-1 items-center gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            ...
            <p className="mt-4 font-sans text-xs text-ink-faint">
              Illustrative representation of the Sentrix integrity console.
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <DashboardPreview />
        ...
        <div className="container-content grid grid-cols-1 gap-9 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          ...
          <Reveal delay={0.1}>
            {/* SPACE: update these specific figures as more current sector data becomes
                available - the paragraph is written to remain quotable if the numbers move. */}
            <p className="text-lg leading-relaxed text-ink-secondary">
              ...
              conventional inspection capacity can scale, and methane is moving from an{' '}
              <span className="text-ink">estimated</span> to a{' '}
              <span className="text-ink">measured</span> quantity under regimes such as OGMP 2.0.
              India is one clear example of the pace involved: its City Gas Distribution sector
              alone is being built out across{' '}
              <span className="text-ink">300+ authorised geographical areas</span>. The same gap
              between pipeline length and inspection throughput exists on gas networks everywhere -
              the gap Sentrix is built to close by prioritising where scarce inspection effort goes.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <Reveal>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-base text-ink-muted">
                No fabricated logos, no invented case studies. We’ll name engagements here the
                moment they’re real.
              </p>
            </div>
          </Reveal>
        ...
        <div className="container-content grid grid-cols-1 gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <Reveal>
            ...
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-ink-secondary">
              ...
              already run, not to become another platform you have to adopt wholesale. And we’re
              explicit about our limits: Sentrix does not measure pipe-wall thickness and does not
              sense underground. Naming what a tool doesn’t do is, we think, the clearest signal
              that the things it does do are real.
            </p>
